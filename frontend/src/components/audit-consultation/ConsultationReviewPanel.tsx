...
export default function ConsultationReviewPanel({
        ...
        >
          ...
          <div className="grid grid-cols-[0.5fr_1.05fr_1.25fr_0.55fr_0.55fr_0.55fr_0.55fr_auto] items-center gap-3 w-full">
              ...
              <div className="flex items-center justify-center gap-1.5 whitespace-nowrap">
                ...
                <div className="rounded-lg bg-blue-50 px-3 py-2 text-center min-w-12 h-13.5 flex flex-col items-center justify-center">
                  <p className="text-[10px] text-gray-500 leading-none">
                    Total
                  </p>
                ...
                <div className="rounded-lg bg-green-50 px-3 py-2 text-center min-w-12 h-13.5 flex flex-col items-center justify-center">
                  <p className="text-[10px] text-gray-500 leading-none">
                    YES
                  </p>
                ...
                <div className="rounded-lg bg-red-50 px-3 py-2 text-center min-w-12 h-13.5 flex flex-col items-center justify-center">
                  <p className="text-[10px] text-gray-500 leading-none">
                    NO
                  </p>
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-1 h-9 rounded-lg bg-blue-600 px-2.5 text-xs text-white shadow hover:bg-blue-700 whitespace-nowrap"
            >
 ...
 hasPermission("api.consultation_management.return") && (
  ...
  <button
    onClick={onBack}
    className="mt-6 inline-flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-6 py-3 text-gray-700 shadow-sm transition hover:bg-gray-50 hover:shadow-md">
    ← Back
  </button>
)}
