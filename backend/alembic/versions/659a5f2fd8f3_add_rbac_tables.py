...
Revision ID: 659a5f2fd8f3
Revises: eaad9868176e
Create Date: 2026-06-12 00:46:08.780448
...
revision: str = "659a5f2fd8f3"
down_revision: Union[str, Sequence[str], None] = "eaad9868176e"
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_permissions_permission_key"),
        "permissions",
        ["permission_key"],
        unique=True,
    )
