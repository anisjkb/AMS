...
FINANCIAL_MENU = {
    "menu_key": "audit_entity_financial_snapshot",
    "menu_title": "Financial Snapshots",
    "route_path": "/audit-entity-financial-snapshots",
    "icon": "ChartNoAxesCombined",
    "permission_key": "menu.audit_entity_financial_snapshot.view",
    "sort_order": 65,
}
...
PERMISSIONS = [
    {
        "permission_key": "menu.audit_entity_financial_snapshot.view",
        "resource_type": "menu",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "view",
        "description": "View audit entity financial snapshot page.",
    },
    {
        "permission_key": "api.audit_entity_financial_snapshot.create",
        "resource_type": "api",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "create",
        "description": "Create audit entity financial snapshot.",
    },
    {
        "permission_key": "api.audit_entity_financial_snapshot.update",
        "resource_type": "api",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "update",
        "description": "Update audit entity financial snapshot.",
    },
    {
        "permission_key": "api.audit_entity_financial_snapshot.delete",
        "resource_type": "api",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "delete",
        "description": "Deactivate audit entity financial snapshot.",
    },
    {
        "permission_key": "api.audit_entity_financial_snapshot.restore",
        "resource_type": "api",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "restore",
        "description": "Restore audit entity financial snapshot.",
    },
    {
        "permission_key": "api.audit_entity_financial_snapshot.permanent_delete",
        "resource_type": "api",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "permanent_delete",
        "description": "Permanently delete audit entity financial snapshot.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.create",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "create",
        "description": "Show create financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.update",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "update",
        "description": "Show update financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.inactive",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "inactive",
        "description": "Show inactive financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.delete",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "delete",
        "description": "Show delete financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.restore",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "restore",
        "description": "Show restore financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.permanent_delete",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "permanent_delete",
        "description": "Show permanent delete financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.export",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "export",
        "description": "Show export financial snapshot button.",
    },
    {
        "permission_key": "button.audit_entity_financial_snapshot.import",
        "resource_type": "button",
        "resource_key": "audit_entity_financial_snapshot",
        "action": "import",
        "description": "Show import financial snapshot button.",
    },
]


MENU_ACTIONS = [
    ("create", "Create", "button.audit_entity_financial_snapshot.create", "green", "Plus", 10),
    ("update", "Update", "button.audit_entity_financial_snapshot.update", "blue", "Pencil", 20),
    ("inactive", "Inactive", "button.audit_entity_financial_snapshot.inactive", "red", "Trash2", 30),
    ("delete", "Delete", "button.audit_entity_financial_snapshot.delete", "red", "Trash2", 35),
    ("restore", "Restore", "button.audit_entity_financial_snapshot.restore", "green", "RotateCcw", 40),
    (
        "permanent_delete",
        "Permanent Delete",
    ...
    ("export", "Export", "button.audit_entity_financial_snapshot.export", "slate", "Download", 60),
    ("import", "Import", "button.audit_entity_financial_snapshot.import", "slate", "Upload", 70),
]
...
async def get_or_create_menu(db, group_id: int) -> Menu:
    result = await db.execute(
        select(Menu).where(Menu.menu_key == FINANCIAL_MENU["menu_key"])
    )
    ...
    if menu:
        ...
        menu.menu_title = FINANCIAL_MENU["menu_title"]
        menu.route_path = FINANCIAL_MENU["route_path"]
        menu.icon = FINANCIAL_MENU["icon"]
        menu.permission_key = FINANCIAL_MENU["permission_key"]
        menu.sort_order = FINANCIAL_MENU["sort_order"]
        menu.menu_level = 1
        menu.is_expandable = False
        menu.is_visible = True
        menu.is_active = True
        menu.updated_by = SYSTEM_USER
        print("Menu updated: audit_entity_financial_snapshot")
        return menu

    menu = Menu(
        navigation_group_id=group_id,
        parent_menu_id=None,
        menu_key=FINANCIAL_MENU["menu_key"],
        menu_title=FINANCIAL_MENU["menu_title"],
        route_path=FINANCIAL_MENU["route_path"],
        icon=FINANCIAL_MENU["icon"],
        permission_key=FINANCIAL_MENU["permission_key"],
        sort_order=FINANCIAL_MENU["sort_order"],
        menu_level=1,
        is_expandable=False,
        is_visible=True,
        is_active=True,
    ...
    print("Menu created: audit_entity_financial_snapshot")
    return menu
...
async def seed_audit_entity_financial_snapshot_navigation() -> None:
    async with AsyncSessionLocal() as db:
        ...
        await get_or_create_menu_permission(
            db=db,
            menu_id=menu.id,
            permission_id=permission_by_key[FINANCIAL_MENU["permission_key"]].id,
        )
    ...
    print("Audit Entity Financial Snapshot seed completed.")


if __name__ == "__main__":
    asyncio.run(seed_audit_entity_financial_snapshot_navigation())
