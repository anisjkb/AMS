...
FINANCIAL_MENU = {
    "menu_key": "audit_entity_tax_assessment",
    "menu_title": "Tax Assessments",
    "route_path": "/audit-entity-tax-assessments",
    "icon": "FileSpreadsheet",
    "permission_key": "menu.audit_entity_tax_assessment.view",
    "sort_order": 70,
}
...
PERMISSIONS = [
    {
        "permission_key": "menu.audit_entity_tax_assessment.view",
        "resource_type": "menu",
        "resource_key": "audit_entity_tax_assessment",
        "action": "view",
        "description": "View audit entity Tax Assessment page.",
    },
    {
        "permission_key": "api.audit_entity_tax_assessment.create",
        "resource_type": "api",
        "resource_key": "audit_entity_tax_assessment",
        "action": "create",
        "description": "Create audit entity Tax Assessment.",
    },
    {
        "permission_key": "api.audit_entity_tax_assessment.update",
        "resource_type": "api",
        "resource_key": "audit_entity_tax_assessment",
        "action": "update",
        "description": "Update audit entity Tax Assessment.",
    },
    {
        "permission_key": "api.audit_entity_tax_assessment.delete",
        "resource_type": "api",
        "resource_key": "audit_entity_tax_assessment",
        "action": "delete",
        "description": "Deactivate audit entity Tax Assessment.",
    },
    {
        "permission_key": "api.audit_entity_tax_assessment.restore",
        "resource_type": "api",
        "resource_key": "audit_entity_tax_assessment",
        "action": "restore",
        "description": "Restore audit entity Tax Assessment.",
    },
    {
        "permission_key": "api.audit_entity_tax_assessment.permanent_delete",
        "resource_type": "api",
        "resource_key": "audit_entity_tax_assessment",
        "action": "permanent_delete",
        "description": "Permanently delete audit entity Tax Assessment.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.create",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "create",
        "description": "Show create Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.update",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "update",
        "description": "Show update Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.inactive",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "inactive",
        "description": "Show inactive Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.delete",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "delete",
        "description": "Show delete Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.restore",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "restore",
        "description": "Show restore Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.permanent_delete",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "permanent_delete",
        "description": "Show permanent delete Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.export",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "export",
        "description": "Show export Tax Assessment button.",
    },
    {
        "permission_key": "button.audit_entity_tax_assessment.import",
        "resource_type": "button",
        "resource_key": "audit_entity_tax_assessment",
        "action": "import",
        "description": "Show import Tax Assessment button.",
    },
]


MENU_ACTIONS = [
    ("create", "Create", "button.audit_entity_tax_assessment.create", "green", "Plus", 10),
    ("update", "Update", "button.audit_entity_tax_assessment.update", "blue", "Pencil", 20),
    ("inactive", "Inactive", "button.audit_entity_tax_assessment.inactive", "red", "Trash2", 30),
    ("delete", "Delete", "button.audit_entity_tax_assessment.delete", "red", "Trash2", 35),
    ("restore", "Restore", "button.audit_entity_tax_assessment.restore", "green", "RotateCcw", 40),
    (
        "permanent_delete",
        "Permanent Delete",
    ...
    ("export", "Export", "button.audit_entity_tax_assessment.export", "slate", "Download", 60),
    ("import", "Import", "button.audit_entity_tax_assessment.import", "slate", "Upload", 70),
]
...
async def get_or_create_menu(db, group_id: int) -> Menu:
    ...
    if menu:
        ...
        print("Menu updated: audit_entity_tax_assessment")
        return menu
    ...
    print("Menu created: audit_entity_tax_assessment")
    return menu
...
async def seed_audit_entity_tax_assessment_navigation() -> None:
    ...
    print("Audit Entity Tax Assessment seed completed.")


if __name__ == "__main__":
    asyncio.run(seed_audit_entity_tax_assessment_navigation())
