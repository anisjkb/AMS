        ...
        for child_data in MEETING_CHILD_MENUS:
            child_menu = await get_or_create_menu(
                ...
                menu_data={
                    **child_data,
                    "is_expandable": False,
                    "initial_is_visible": child_data["menu_key"] in {"meeting_master", "meeting_report", "meeting_participant"},
                    "is_visible": child_data["menu_key"] in {"meeting_master", "meeting_report", "meeting_participant"},
                },
                menu_level=3,
            )
