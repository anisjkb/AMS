...
AUDIT_ENTITY_MENU = {
    "menu_key": "audit_entity",
    "menu_title": "Audit Entities",
    "route_path": "/audit-entities",
    "icon": "Building2",
    "permission_key": "menu.audit_entity.view",
    "sort_order": 20,
}
...
PERMISSIONS = [
    {
        "permission_key": "menu.audit_entity.view",
        "resource_type": "menu",
        "resource_key": "audit_entity",
        "action": "view",
        "description": "View Audit Entities menu and page.",
    },
    {
        "permission_key": "api.audit_entity.view",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "view",
        "description": "View audit entity records.",
    },
    {
        "permission_key": "api.audit_entity.create",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "create",
        "description": "Create audit entity records.",
    },
    {
        "permission_key": "api.audit_entity.update",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "update",
        "description": "Update audit entity records.",
    },
    {
        "permission_key": "api.audit_entity.delete",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "delete",
        "description": "Deactivate audit entity records.",
    },
    {
        "permission_key": "api.audit_entity.restore",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "restore",
        "description": "Restore inactive audit entity records.",
    },
    {
        "permission_key": "api.audit_entity.permanent_delete",
        "resource_type": "api",
        "resource_key": "audit_entity",
        "action": "permanent_delete",
        "description": "Permanently delete audit entity records.",
    },
    {
        "permission_key": "button.audit_entity.view",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "view",
        "description": "Show audit entity view action.",
    },
    {
        "permission_key": "button.audit_entity.create",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "create",
        "description": "Show audit entity create button.",
    },
    {
        "permission_key": "button.audit_entity.update",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "update",
        "description": "Show audit entity update button.",
    },
    {
        "permission_key": "button.audit_entity.delete",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "delete",
        "description": "Show audit entity inactive/delete button.",
    },
    {
        "permission_key": "button.audit_entity.restore",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "restore",
        "description": "Show audit entity restore button.",
    },
    {
        "permission_key": "button.audit_entity.permanent_delete",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "permanent_delete",
        "description": "Show audit entity permanent delete button.",
    },
    {
        "permission_key": "button.audit_entity.export",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "export",
        "description": "Show audit entity export button.",
    },
    {
        "permission_key": "button.audit_entity.import",
        "resource_type": "button",
        "resource_key": "audit_entity",
        "action": "import",
        "description": "Show audit entity import button.",
    },
]
...
async def get_or_create_audit_entity_menu(db, group_id: int) -> Menu:
    result = await db.execute(
        select(Menu).where(Menu.menu_key == AUDIT_ENTITY_MENU["menu_key"])
    )
    ...
    if menu:
        ...
        menu.menu_title = AUDIT_ENTITY_MENU["menu_title"]
        menu.route_path = AUDIT_ENTITY_MENU["route_path"]
        menu.icon = AUDIT_ENTITY_MENU["icon"]
        menu.permission_key = AUDIT_ENTITY_MENU["permission_key"]
        menu.sort_order = AUDIT_ENTITY_MENU["sort_order"]
        menu.menu_level = 1
        ...
        print("Menu updated: audit_entity")
        return menu

    menu = Menu(
        navigation_group_id=group_id,
        parent_menu_id=None,
        menu_key=AUDIT_ENTITY_MENU["menu_key"],
        menu_title=AUDIT_ENTITY_MENU["menu_title"],
        route_path=AUDIT_ENTITY_MENU["route_path"],
        icon=AUDIT_ENTITY_MENU["icon"],
        permission_key=AUDIT_ENTITY_MENU["permission_key"],
        sort_order=AUDIT_ENTITY_MENU["sort_order"],
        menu_level=1,
        is_expandable=False,
        is_visible=True,
        is_active=True,
    ...
    print("Menu created: audit_entity")
    return menu
...
async def get_or_create_menu_action(
    ...
    if action:
        ...
        print(f"Menu action updated: audit_entity.{action.action_key}")
        return action
    ...
    print(f"Menu action created: audit_entity.{action.action_key}")
    return action
...
async def get_or_create_menu_permission(
    ...
    if mapping:
        ...
        print("Menu permission mapping updated: audit_entity")
        return mapping
    ...
    print("Menu permission mapping created: audit_entity")
    return mapping
...
async def get_or_create_menu_action_permission(
    ...
    if mapping:
        ...
        print(f"Menu action permission mapping updated: audit_entity.{action_key}")
        return mapping
    ...
    print(f"Menu action permission mapping created: audit_entity.{action_key}")
    return mapping
...
async def seed_audit_entity_navigation_permissions() -> None:
    async with AsyncSessionLocal() as db:
        ...
        menu = await get_or_create_audit_entity_menu(db, group.id)

        menu_permission = await get_permission_by_key(
            db,
            AUDIT_ENTITY_MENU["permission_key"],
        )
        ...
        for action_data in AUDIT_ENTITY_ACTIONS:
    ...
    print("Audit Entity navigation and permission seed completed.")


if __name__ == "__main__":
    asyncio.run(seed_audit_entity_navigation_permissions())
