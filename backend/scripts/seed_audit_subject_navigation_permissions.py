...
AUDIT_GROUP = {
    ...
    "sort_order": 20,
    "group_permission_key": "menu.audit_subject.view",
}


AUDIT_SUBJECT_MENU = {
    "menu_key": "audit_subject",
    "menu_title": "Audit Subjects",
    "route_path": "/audit-subjects",
    "icon": "ClipboardList",
    "permission_key": "menu.audit_subject.view",
    "sort_order": 10,
}
...
PERMISSIONS = [
    {
        "permission_key": "menu.audit_subject.view",
        "resource_type": "menu",
        "resource_key": "audit_subject",
        "action": "view",
        "description": "View Audit Subjects menu and page.",
    },
    {
        "permission_key": "api.audit_subject.view",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "view",
        "description": "View audit subject records.",
    },
    {
        "permission_key": "api.audit_subject.create",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "create",
        "description": "Create audit subject records.",
    },
    {
        "permission_key": "api.audit_subject.update",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "update",
        "description": "Update audit subject records.",
    },
    {
        "permission_key": "api.audit_subject.delete",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "delete",
        "description": "Deactivate audit subject records.",
    },
    {
        "permission_key": "api.audit_subject.restore",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "restore",
        "description": "Restore inactive audit subject records.",
    },
    {
        "permission_key": "api.audit_subject.permanent_delete",
        "resource_type": "api",
        "resource_key": "audit_subject",
        "action": "permanent_delete",
        "description": "Permanently delete audit subject records.",
    },
    {
        "permission_key": "button.audit_subject.view",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "view",
        "description": "Show audit subject view action.",
    },
    {
        "permission_key": "button.audit_subject.create",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "create",
        "description": "Show audit subject create button.",
    },
    {
        "permission_key": "button.audit_subject.update",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "update",
        "description": "Show audit subject update button.",
    },
    {
        "permission_key": "button.audit_subject.delete",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "delete",
        "description": "Show audit subject inactive/delete button.",
    },
    {
        "permission_key": "button.audit_subject.restore",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "restore",
        "description": "Show audit subject restore button.",
    },
    {
        "permission_key": "button.audit_subject.permanent_delete",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "permanent_delete",
        "description": "Show audit subject permanent delete button.",
    },
    {
        "permission_key": "button.audit_subject.export",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "export",
        "description": "Show audit subject export button.",
    },
    {
        "permission_key": "button.audit_subject.import",
        "resource_type": "button",
        "resource_key": "audit_subject",
        "action": "import",
        "description": "Show audit subject import button.",
    },
]


AUDIT_SUBJECT_ACTIONS = [
    {
        "action_key": "create",
        "action_title": "Create",
        "permission_key": "button.audit_subject.create",
...
async def get_or_create_audit_group(db) -> NavigationGroup:
    ...
    if group:
        ...
        group.group_permission_key = AUDIT_GROUP["group_permission_key"]
    ...
    group = NavigationGroup(
        ...
        group_permission_key=AUDIT_GROUP["group_permission_key"],
        is_active=True,
        is_visible=True,
        created_by=SYSTEM_USER,
        updated_by=SYSTEM_USER,
...
async def get_or_create_audit_subject_menu(db, group_id: int) -> Menu:
    result = await db.execute(
        select(Menu).where(Menu.menu_key == AUDIT_SUBJECT_MENU["menu_key"])
    )
    ...
    if menu:
        ...
        menu.menu_title = AUDIT_SUBJECT_MENU["menu_title"]
        menu.route_path = AUDIT_SUBJECT_MENU["route_path"]
        menu.icon = AUDIT_SUBJECT_MENU["icon"]
        menu.permission_key = AUDIT_SUBJECT_MENU["permission_key"]
        menu.sort_order = AUDIT_SUBJECT_MENU["sort_order"]
        menu.menu_level = 1
        ...
        print("Menu updated: audit_subject")
        return menu

    menu = Menu(
        navigation_group_id=group_id,
        parent_menu_id=None,
        menu_key=AUDIT_SUBJECT_MENU["menu_key"],
        menu_title=AUDIT_SUBJECT_MENU["menu_title"],
        route_path=AUDIT_SUBJECT_MENU["route_path"],
        icon=AUDIT_SUBJECT_MENU["icon"],
        permission_key=AUDIT_SUBJECT_MENU["permission_key"],
        sort_order=AUDIT_SUBJECT_MENU["sort_order"],
        menu_level=1,
        is_expandable=False,
        is_visible=True,
        is_active=True,
    ...
    print("Menu created: audit_subject")
    return menu
...
async def get_or_create_menu_action(
    ...
    if action:
        ...
        print(f"Menu action updated: audit_subject.{action.action_key}")
        return action
    ...
    print(f"Menu action created: audit_subject.{action.action_key}")
    return action
...
async def get_or_create_menu_permission(
    ...
    if mapping:
        ...
        print("Menu permission mapping updated: audit_subject")
        return mapping
    ...
    print("Menu permission mapping created: audit_subject")
    return mapping
...
async def get_or_create_menu_action_permission(
    ...
    if mapping:
        ...
        print(f"Menu action permission mapping updated: audit_subject.{action_key}")
        return mapping
    ...
    print(f"Menu action permission mapping created: audit_subject.{action_key}")
    return mapping
...
async def seed_audit_subject_navigation_permissions() -> None:
    async with AsyncSessionLocal() as db:
        ...
        menu = await get_or_create_audit_subject_menu(db, group.id)

        menu_permission = await get_permission_by_key(
            db,
            AUDIT_SUBJECT_MENU["permission_key"],
        )
        ...
        for action_data in AUDIT_SUBJECT_ACTIONS:
    ...
    print("Audit Subject navigation and permission seed completed.")


if __name__ == "__main__":
    asyncio.run(seed_audit_subject_navigation_permissions())
